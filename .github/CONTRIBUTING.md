...
- Follow the template of issues/PR while creating issues and before making a PR.
...
>Remember, the project maintainers are also human. Please be patient if it takes time to review your PR. We will get back to you within 2 days of opening the PR.

>CONTRIBUTING.md borrowed from [FOSSASIA/susi_chromebot](https://github.com/fossasia/susi_chromebot/blob/master/.github/CONTRIBUTING.md) with few added comments.